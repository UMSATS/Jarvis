...
const { magFieldMeasurements, adcsTags, magFieldMeasurementsTag, magFieldMeasurementsFields, angVelocityMeasurementsTag, angVelocityMeasurementsFields } = require('../measurements/adcsMeasurements');
 ...
 */
exports.magFieldMeasurements = async (req, res) => {};
 ...
 * @query end The end time of the period to get the data
 */
exports.angVelocityMeasurements = async (req, res) => {};